            ...
            <div className='grid grid-cols-4'>
                {
                    getList.title.map((title, i) =>
                        <div key={title} className="relative overflow-hidden w-[250px] h-[300px] rounded-xl text-white hover:animate-bounce">
                            <img className="absolute top-0 left-0 w-full h-full border border-slate-300  " src={getList.img[i]} alt="Sunset in the mountains" />
